...
import { getDataDir } from "../metadata/covers";
import { extractIsbnCandidates } from "../isbn/extract";
...
export async function runOcr(file: Blob): Promise<OcrResult | { error: string }> {
